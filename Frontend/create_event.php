...
<form enctype="multipart/form-data" action="create_event_handler.php">
	  ...
	  <p>Location:&nbsp <input type="text" name="Location" size="10" maxlength="20" /></p>
	  ...
	  <!-- Should add more fields - maybe specifically time start and time end, maybe different column for main host (the current user) and
	   cohosts, tags, etc. -->
	  <br>
