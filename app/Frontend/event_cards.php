<div style = "background-color: #fafafa">
	...
	<div class="w3-container" style="width: 85%; margin: auto;">
		<div class='w3-row' style='margin: auto;'>
			...
			if($valid){
				$sql = "SELECT DISTINCT events.event_id,events.event_title, events.event_description, events.event_location, events.event_start_date_time, events.event_end_date_time, events.event_start_time, events.event_end_time, events.event_tags FROM events INNER JOIN event_guests WHERE events.event_host_account_id='$id' OR events.event_is_hidden=0 OR (event_guests.account_id='$id' AND event_guests.event_id=events.event_id);";
			}
