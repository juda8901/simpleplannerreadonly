<div class="w3-bar w3-white w3-top" style =" top:0; left:0; z-index:1;">
  ...
  <a href="Frontend/login.php" class="w3-bar-item w3-right w3-button w3-hover-white" style="height: 40px;" id="login">Log In</a>
  <a href="https://simpleplanner.herokuapp.com/Backend/logout.php" class="w3-bar-item w3-right w3-button w3-hover-white" style="height: 40px;" id="logout">Log Out</a>
  <a onclick="document.getElementById('sign_up').style.display='block'" class=" w3-bar-item w3-right w3-button w3-hover-white" style="height: 40px;" id="reg">Sign Up</a>
