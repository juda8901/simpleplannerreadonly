<div class="w3-bar w3-white w3-top" style =" top:0; left:0; z-index:1;">
  ...
  <a href="https://simpleplanner.herokuapp.com/Frontend/login.php" class="w3-bar-item w3-right w3-button w3-hover-light-gray" style="height: 40px;" id="login">Log In</a>
  <a href="https://simpleplanner.herokuapp.com/Backend/logout_handler.php" class="w3-bar-item w3-right w3-button w3-hover-light-gray" style="height: 40px;" id="logout">Log Out</a>
