...
<div class="w3-bar w3-white w3-top">
  <a href="https://simpleplanner.herokuapp.com" class="w3-bar-item w3-left w3-button"><img src="https://simpleplanner.herokuapp.com/Frontend/images/treeLogo.png" style="width: 20px; height: 20px;"><span id="nav_title" style=" color: #F64060; display: none;">  Simpleplanner</span></a>
