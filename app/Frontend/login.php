...
<body style= "background-color:#fafafa;">
	...
	<center style="margin-top: 7.5%; background-color:white;">
		<form action="" method="post" style="margin: 20px 0px 20px 0px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); width: 20em; height: 25em;">
			...
			<div class="container">
				...
				<input type="submit" name="submit" class="w3-center w3-btn w3-xlarge w3-hover-white w3-btn" value="Log in" style="color: #f13a59; margin: 20px 20px 20px 20px; font-weight:650;"/>
