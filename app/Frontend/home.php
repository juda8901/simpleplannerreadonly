...
<div class="homepage-hero-module">
	<div class="video-container">
		...
		<header class="w3-theme" id="Header">
			...
			<h2>
				<a href="" class="typewrite" style="text-decoration: none; font-size: 25px; color:#212C33; background-color: rgba(FF,FF,FF,0.2);" data-type='[ "Planning made simple.", "Change the world.", "Flawlessly connect with others." ]'>
