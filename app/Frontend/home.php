...
<body>
	...
	<div id="search_bar" style="width: 100%; text-align: center;">
		...
		<button type="submit" class="w3-button w3-hover-blue-grey" style="width: auto; height: auto; padding: 0; margin:0px;" id="search" value="search"><img src="https://simpleplanner.herokuapp.com/Frontend/images/searchicon.png" style="width: 20px; height: 20px;"><i class="fa fa-search" style="zoom: 1.75; padding: 0; margin: 0; margin-bottom: 5;"></i></button>
