...
<div class="homepage-hero-module">
	<div class="video-container">
		...
		<header class="w3-theme" id="Header">
			...
			<h2>
				<a href="" class="typewrite" style="text-decoration: none; font-size: 25px; color:#212C33; background-color: rgba(255,255,255,0.2);" data-type='[ "Planning made simple.", "Change the world.", "Flawlessly connect with others." ]'>
			...
			<div class='w3-row' style='margin: auto;'>
				...
				if ($result->num_rows > 0) {
					...
					while($row = $result->fetch_assoc()) {
						...
						<div style='width: 100%; height: 30%;' id='card_title'><span>".$title."</span></div>
